import type { Config, HighlightColor } from "./common/types/config.ts";
import { DEFAULT_CONFIG } from "./common/types/config.ts";
import { validateHighlightGroupName } from "./common/utils/validator.ts";
